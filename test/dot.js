...
exports.testDotGraph = function (test) {
  ...
  var expectedOutput = 'digraph G {\n  "builderOutput-DOT_TEST-1 (BUILDER OUTPUT)" [ color = "green" ];\n' +
    ...
    '  "name-toUpper-peerGroup1 (name-toUpper)" -> "builderOutput-DOT_TEST-1 (BUILDER OUTPUT)";\n' +
    '  "req" -> "req.query";\n' +
    '  "req.query" -> "req.query.name";\n' +
    '  "req.query.name" -> "name-toLower-peerGroup1 (name-toLower)";\n' +
    '  "name-toLower-peerGroup1 (name-toLower)" -> "builderOutput-DOT_TEST-1 (BUILDER OUTPUT)";\n' +
    '  "age-peerGroup1 (age)" -> "builderOutput-DOT_TEST-1 (BUILDER OUTPUT)";\n}\n'
