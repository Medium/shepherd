...
/**
 * Creates a function which returns its first input argument
 *
 * @param {Object} data
 * @return {Object} returns data
 */
Graph.prototype.subgraph = function (data) {
...
Graph.prototype.add = function (name, fn, deps) {
  ...
  if (typeof fn === 'string') {
    ...
    if (this._nodeDefinitions[name]) throw new Error('This node already exists')
...
Graph.prototype.newAsyncBuilder = function () {
  if (this._forceClone) return this.clone().newAsyncBuilder()
