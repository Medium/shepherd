...
function Graph() {
  ...
  this.add('bool-greaterThan', nodes.greaterThan, ['val1', 'val2'])
  this.add('bool-lessThan', nodes.lessThan, ['val1', 'val2'])
  this.add('bool-equalTo', nodes.equalTo, ['val1', 'val2'])
  this.add('bool-isUndefined', nodes.isUndefined, ['val'])
  this.add('bool-isNull', nodes.isNull, ['val'])
  this.add('bool-isNullish', nodes.isNullish, ['val'])
}
