...
Graph.prototype.disableCallbacks = function () {
  if (this._forceClone) return this.clone().disableCallbacks()
  this._useCallbacks = false
  return this
}
...
Graph.prototype.clone = function () {
  ...
  graph._useCallbacks = this._useCallbacks
...
Graph.prototype.newAsyncBuilder = function (name) {
  ...
  return this._builders[name] = new Builder(this, name, {
    useCallbacks: this._useCallbacks
  })
}
