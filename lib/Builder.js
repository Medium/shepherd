...
Builder.prototype.setDebugger = function (dbg) {
  this._debugger = dbg
  this.setProfilingFrequency(1)
  return this
}
...
Builder.prototype.setProfilingFrequency = function (profilingFrequency) {
  if (this._debugger) profilingFrequency = 1
...
Builder.prototype._generateHashesForNode = function (nodeName) {
  ...
  for (var key in node.inputs) {
    ...
    if (dep && dep.cacheDisabled && node.implicitInputs.indexOf(depNodeName) === -1) {
...
Builder.prototype.compile = function (runInputs) {
  ...
  this._prepareInputlessLiterals()
...
Builder.prototype._run = function (inputData) {
  ...
  if (this._debugger) {
    buildId = this._debugger.addBuild(this, data)
  }
  ...
  if (this._debugger) {
    defer.promise
      .then(function (e) {
        console.error("Build id '" + buildId + "' succeeded")
      })
      .fail(function (e) {
        console.error("Build id '" + buildId + "' failed")
      })
  }
...
Builder.prototype._getErrorHandler = function (nodeName) {
  var errorWrapper = _wrapError.bind(null, this._name, this._compiled.nodes, this._compiled.nodes[nodeName])
