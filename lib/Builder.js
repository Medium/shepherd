 ...
 * @throws {Error}
 */
Builder.prototype._wrapError = function (node, e) {
  var key, found, i
...
Builder.prototype._getResolver = function (nodeName) {
  ...
  var errorWrapper = this._wrapError.bind(this, node)
  ...
  return this._resolvers[nodeName] = function (data) {
    ...
    .then(function (response) {
      if (startTime) profiler(node.originalName, startTime)
    ...
    .fail(function (e) {
      if (!(e instanceof ConditionalError)) e = errorWrapper(e)
