 ...
 */
Builder.prototype.describe = function (field) {
  return this._outputNode.describe(field)
}
...
Builder.prototype._resolve = function (context, nodeName) {
  if (context[nodeName]) return Q.resolve(context[nodeName])
...
Builder.prototype._getResolver = function (nodeName) {
  ...
  if (node.isLiteral) {
    ...
    if (this._config.useCallbacks) {
      ...
      handlerChain.push({handler: function (data) {
        var context = data.context
