 ...
 *
 * @param {string} nodeName
 * @return {function(Object)} the quiet input validator which will return an error
 ...
 *
 * @param {string} nodeName
 * @return {function(Object, Array)} the argument input validator which
 *     will return an error if an input has failed. Modifies the array
