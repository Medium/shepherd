...
NodeDefinition.prototype.if = function (field) {
  this._ifSectionIndexes.push({
    counter: this._ifCounter++,
    idx: 0
  })
  return this.builds(field)
}

NodeDefinition.prototype.then = function () {
  return this
}

NodeDefinition.prototype.else = function () {
  var section = this._ifSectionIndexes[this._ifSectionIndexes.length - 1]
  section.idx++
  return this
}

NodeDefinition.prototype.elseIf = function (field) {
  var section = this._ifSectionIndexes[this._ifSectionIndexes.length - 1]
  section.idx++
  return this.builds(field)
}
