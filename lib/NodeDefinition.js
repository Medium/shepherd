...
/**
 * Start describing a field for conditional guard purposes
 *
...
/**
 * Specify the where clause for the last publicly visible .builds()
 * node
 *
 * @param {string} field
 * @return {NodeDefinition} the current instance
...
NodeDefinition.prototype.end = function () {
  if (this._conditionalState.nextCandidate) {
    ...
    var elseNodeName = this._graph.addAnonymous('conditionalElse', conditionalElse)
