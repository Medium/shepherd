...
var NODE_NAME_RE = /^[!?+]?[a-zA-Z_*][-*a-zA-Z0-9_]*([.][a-zA-Z_*][a-zA-Z0-9_]*)*$/
...
/**
 * @return {string}
 * @deprecated You really should use the aliasRealName.
 */
...
/** @return {boolean} */
NodeInfo.prototype.isSilent = function () {
  return isSilentNode(this._alias)
}


/** @return {boolean} */
NodeInfo.prototype.isOptional = function () {
  return isOptionalNode(this._alias)
}
 ...
 * @constructor
 */
// TODO(nick): nodeName is totally a misnomer.
function NodeArgInfo(arg, nodeName) {
  assertValidNodeName(arg)
  if (typeof nodeName == 'string') assertValidNodeName(arg)
...
/**
 * @param {string|Object} A graph node spec.
...
module.exports = {
  ...
  OUTPUT_PREFIX_SILENT: OUTPUT_PREFIX_SILENT,
  OUTPUT_PREFIX_OPTIONAL: OUTPUT_PREFIX_OPTIONAL,
