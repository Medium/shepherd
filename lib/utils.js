...
function NodeInfo(sourceName, targetName) {
  /** @type {string} */
  this.rawName = sourceName

  /** @type {string} */
  this.fullName = getNodeRealName(this.rawName)

  /** @type {string} */
  this.rootName = getNodeRootName(this.fullName)

  /** @type {string} */
  this.alias = targetName ? targetName : sourceName.replace(/\./g, '_')

  /** @type {string} */
  this.aliasRealName = getNodeRealName(this.alias)
}
...
module.exports = {
  ...
  INPUT_ARG_PREFIX: INPUT_ARG_PREFIX,
